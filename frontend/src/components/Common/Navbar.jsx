      ...
      <nav className="container mx-auto flex items-center justify-between py-4 px-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="relative hover:text-black pr-3"
          >
            <HiOutlineShoppingBag className="h-6 w-6 text-green-700" />
            {cartItemCount > 0 && (
              <span
                className="absolute -top-2 bg-red-500 text-white text-xs rounded-full px-2
              py-0.5"
              >
                {cartItemCount}
              </span>
        ...
        <div className="p-4 bg-emerald-100">
          ...
          <nav className="space-y-4 flex flex-col  items-center">
            <Link
              ...
              className="block text-gray-600 hover:text-black hover:px-3 py-2 hover:bg-amber-300 rounded"
            >
              Men
            </Link>
            <Link
